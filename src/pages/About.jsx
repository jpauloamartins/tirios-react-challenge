      ...
      <section className="relative bg-secondary-900 dark:bg-black text-white py-24">
        <div className="container">
          ...
          >
            ...
            <p className="text-xl text-secondary-200 dark:text-secondary-400">
      ...
      <section className="py-16 bg-white dark:bg-secondary-800">
        <div className="container">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            >
              <div className="bg-primary-50 dark:bg-primary-900/50 p-4 rounded-full w-20 h-20 flex items-center justify-center mx-auto mb-4">

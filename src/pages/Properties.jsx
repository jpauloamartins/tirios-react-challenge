        ...
        <div className="container py-6">
          <div className="flex justify-between items-center">
            ...
            <div className="flex items-center space-x-4">
              <button
                className={`p-2 rounded-md ${showFilters ? 'bg-primary-100 text-primary-600 dark:bg-primary-900 dark:text-primary-400' : 'hover:bg-secondary-100 dark:hover:bg-secondary-700 text-secondary-600 dark:text-secondary-300'}`}
            ...
            >
              <Link to={`/properties/${property.id}`}>
                ...
                <div className="p-6">
                  ...
                  {/* Token Details */}
                  <div className="bg-secondary-50 dark:bg-secondary-700/50 rounded-lg p-3 mb-4">
                    <div className="flex justify-between text-sm">
